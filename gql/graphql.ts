...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', id: string, email?: string | null, firstName: string, lastName: string, profileImageURL?: string | null } | null };
